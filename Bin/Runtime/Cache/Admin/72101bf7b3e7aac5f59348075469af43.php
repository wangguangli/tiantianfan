                ...
                <div class="v-container">
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            ...
                            <form class="v-filter-container" action="<?php echo U('ipo');?>" method="get"
                                ...
                                <div class="filter-fields-wrap">
                                    <div class="filter-item clearfix">
                                        <div class="filter-item__field">
                                            ...
                                            <div class="v__control-group">
                                                <label class="v__control-label">今日已返金额</label>
                                                <div class="v__controls">
                                                    <input type="text"
                                            ...
                                            <div class="v__control-group">
                                                <label class="v__control-label">总返还金额</label>
                                                <div class="v__controls">
                                                    <input type="text"
                                                           value="<?php echo ($all); ?>" class="v__control_input"
                                                           autocomplete="off" readonly  style="color: red;">
                                                </div>
                                            </div>
