                ...
                <div class="v-container">
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            ...
                            <form class="v-filter-container" action="<?php echo U('all_money');?>" method="get"
                                ...
                                <div class="filter-fields-wrap">
                                    <div class="filter-item clearfix">
                                        <div class="filter-item__field">
                                            ...
                                            <div class="v__control-group">
                                                <label class="v__control-label">奖金池</label>
                                                <div class="v__controls">
                                                    <input type="text"
...
<!--                                            <div class="v__control-group">-->
<!--                                                <label class="v__control-label">昨日新增</label>-->
<!--                                                <div class="v__controls">-->
<!--                                                    <input type="text"-->
<!--                                                           value="<?php echo ($yes); ?>" class="v__control_input"-->
<!--                                                           autocomplete="off" readonly  style="color: red;">-->
<!--                                                </div>-->
<!--                                            </div>-->
                                            <div class="v__control-group">
                                                <label class="v__control-label">今日新增</label>
                                                <div class="v__controls">
                                                    <input type="text"
                                                           value="<?php echo ($today); ?>" class="v__control_input"
                                                           autocomplete="off" readonly  style="color: red;">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <table class="table datatable-tools-basic basic_table">
                                ...
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="tt_color">
                                        ...
                                        <td class="">
                                            <div class="ed_stand">
                                                <div class="ed_stand">
                                                    <p>UID:<?php echo ($vo["user_user_id"]); ?></p>
                                                    <p>姓名:<?php echo ($vo["user_name"]); ?></p>
