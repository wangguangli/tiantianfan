										...
										<div class="filter-item__field">
											<div class="v__control-group">
												...
												<div class="v__controls">
													<input type="text" name="order_no" value="<?php echo ($_REQUEST['order_no']); ?>" class="v__control_input" placeholder="请输入订单编号" autocomplete="off">
												</div>
											</div>
											<div class="v__control-group">
												<label class="v__control-label">商品名称</label>
												<div class="v__controls">
													<input type="text" class="v__control_input" name="goods_name" value="<?php echo ($_REQUEST['goods_name']); ?>" placeholder="请输入商品名称" autocomplete="off">
												</div>
											</div>
											<div class="v__control-group">
												<label class="v__control-label">快递单号</label>
												<div class="v__controls">
													<input type="text" class="v__control_input" name="tracking_number" value="<?php echo ($_REQUEST['tracking_number']); ?>" placeholder="请输入快递单号" autocomplete="off">
												</div>
											</div>
											<div class="v__control-group">
												<label class="v__control-label">会员信息</label>
												<div class="v__controls">
													<input type="text" class="v__control_input" name="content" value="<?php echo ($_REQUEST['content']); ?>" autocomplete="off" placeholder="手机号码/会员ID/用户名">
												</div>
											</div>
											<div class="v__control-group">
												...
												<div class="v__controls">
													<select class="v__control_input" name="payment_type">
														...
														<option value="yepay" <?php if($_REQUEST['payment_type'] == 'yepay' ): ?>selected<?php endif; ?> >佣金支付</option>
														<option value="wxpay"
...
<!--														>金额支付</option>-->
														...
														>后台支付</option>
<!--														<option value="yepay" <?php if($_REQUEST['payment_type'] == 'yepay' ): ?>selected<?php endif; ?> >余额支付</option>-->
<!--														<option value="alipay" <?php if($_REQUEST['payment_type'] == 'alipay' ): ?>selected<?php endif; ?> >支付宝</option>-->
<!--														<option value="wxpay" <?php if($_REQUEST['payment_type'] == 'wxpay' ): ?>selected<?php endif; ?> >微信支付</option>-->
											...
											<div class="v__control-group">
												...
												<div class="v__controls">
													<select class="v__control_input" name="order_status">
														<option value="-1" <?php if($_REQUEST['order_status'] == -1 ): ?>selected<?php endif; ?> >全部</option>
														<option value="-2" <?php if($_REQUEST['order_status'] == '-2' ): ?>selected<?php endif; ?> >待支付</option>
														<option value="1" <?php if($_REQUEST['order_status'] == 1 ): ?>selected<?php endif; ?> >待发货</option>
														<option value="2" <?php if($_REQUEST['order_status'] == 2 ): ?>selected<?php endif; ?> >待收货</option>
														<option value="3" <?php if($_REQUEST['order_status'] == 3 ): ?>selected<?php endif; ?> >已收货</option>
														<option value="4" <?php if($_REQUEST['order_status'] == 4 ): ?>selected<?php endif; ?> >取消(未支付)</option>
														<option value="5" <?php if($_REQUEST['order_status'] == 5 ): ?>selected<?php endif; ?> >评价完成</option>
														<option value="6" <?php if($_REQUEST['order_status'] == 6 ): ?>selected<?php endif; ?> >售后</option>
													</select>
												</div>
											</div>
											<!--<div class="v__control-group">
											...
											<div class="v__control-group">
												...
												<div class="v__controls v-date-input-control">
													<label for="add_time">
														<input type="text" class="v__control_input pr-30" id="add_time"  name="add_time" value="<?php echo ($_REQUEST['add_time']); ?>" placeholder="请选择时间" autocomplete="off" data-types="datetime" lay-key="1">
											...
											<div class="v__control-group">
												...
												<div class="v__controls v-date-input-control">
													<label for="pay_time">
														<input type="text" class="v__control_input pr-30" id="pay_time" name="pay_time" value="<?php echo ($_REQUEST['pay_time']); ?>" placeholder="请选择时间" autocomplete="off" data-types="datetime" lay-key="2">
														<i class="icon icon-calendar"></i>
													</label>
												</div>
											</div>
											<div class="v__control-group">
												...
												<div class="v__controls v-date-input-control">
													<label for="shipping_time">
														<input type="text" class="v__control_input pr-30" id="shipping_time" name="shipping_time" value="<?php echo ($_REQUEST['shipping_time']); ?>" placeholder="请选择时间" autocomplete="off" data-types="datetime" lay-key="3">
														<i class="icon icon-calendar"></i>
													</label>
												</div>
											</div>
											<div class="v__control-group">
												...
												<div class="v__controls v-date-input-control">
													<label for="confirm_time">
														<input type="text" class="v__control_input pr-30" id="confirm_time" name="confirm_time" value="<?php echo ($_REQUEST['confirm_time']); ?>" placeholder="请选择时间" autocomplete="off" data-types="datetime" lay-key="4">
														<i class="icon icon-calendar"></i>
													</label>
												</div>
											</div>
											<div class="v__control-group">
												...
												<div class="v__controls">
													<input type="text" class="v__control_input" name="trade_no" value="<?php echo ($_REQUEST['trade_no']); ?>" autocomplete="off" placeholder="支付流水号/第三方微信、支付宝订单号">
												</div>
											</div>
										</div>
									</div>
						...
						<div class="dataTables_wrapper no-footer">
							<table class="table datatable-tools-basic basic_table border_btm_ddd">
								...
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><table class="table v-table table-auto-center mb-10" style="border: 1px solid #ddd;margin-top: 10px;">
										...
										<tr class="tt_color">
											...
											<td class="col-xs-3">
												<?php if(is_array($vo['goods'])): $i = 0; $__LIST__ = $vo['goods'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?><div class="id_stand">
														<img src="<?php echo ($sub["goods_thumb"]); ?>" style="width: 80px;height: 80px;" class="stand_left"/>
											...
											<td class="text-center col-xs-3">
												<div class="dd_stand">
													...
													<p>实际付款：<span style="color: #DB5D5A;">￥<?php echo ($vo["total_commodity_price"]); ?></span></p>
												</div>
											</td>
											<td class="col-xs-2">
												<div class="zt_stand">
													<p>订单状态：<span class="layui-bg-blue"><?php echo ($vo["order_status_cn"]); ?></span></p>
													<p>支付状态：<span class="layui-bg-green"><?php echo ($vo['pay_status_cn']); ?></span></p>
													<p>支付方式：<span class="layui-bg-green"><?php echo ($vo['payment_type_cn']?$vo['payment_type_cn']:'无'); ?></span></p>
													<p>发货状态：<span class="layui-bg-cyan"><?php echo ($vo['shipping_status_cn']); ?> </span></p>
													<p>发货方式：<span class="layui-bg-cyan"><?php echo ($vo['shipping_type_cn']); ?> </span></p>
												</div>
											</td>
											<td class="text-center col-xs-2">
												<div class="tt_stand">
													<a title="查看详情" href="<?php echo U('Order/detail', array('id'=>$vo['id']));?>" class="layui-btn layui-btn-sm layui-btn-normal btn_detail">详情</a>
													<a title="删除订单" href="<?php echo U('Order/delete', array('id'=>$vo['id']));?>" class="layui-btn layui-btn-sm layui-btn-danger btn_detail" onclick="return confirm('确定要删除吗?');">删除</a>
												</div>
											</td>
										</tr>
										<tr class="title-tr">
